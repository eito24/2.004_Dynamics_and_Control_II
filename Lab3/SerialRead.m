...
figure(1)
plot(data(:,1)-data(1,1), data(:,2),'g', data(:,1)-data(1,1), data(:,3),'b', data(:,1)-data(1,1), data(:,4),'r')
title('Serial Data')
xlabel('Time (sec)'),ylabel('Values'), grid
legend('Setpoint','Velocity','PWM voltage');
...
% Use the command below to force clear any open com port if needed
% delete(instrfind);
